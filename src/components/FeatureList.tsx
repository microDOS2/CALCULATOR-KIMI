...
const features: FeatureSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Auto-Diff — Scalar changes detected automatically via state comparison (no manual instrumentation needed)" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Comprehensive User Guide — Complete walkthrough of all 18 tabs with tips and feature descriptions" },
