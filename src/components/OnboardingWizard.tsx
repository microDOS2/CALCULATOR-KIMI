...
const tabColorLegend = [
  ...
  { label: "Dashboard", cls: "bg-violet-200 text-violet-800", tabs: "11-13" },
  { label: "Forecasting", cls: "bg-amber-200 text-amber-800", tabs: "14-16" },
  { label: "Management", cls: "bg-slate-200 text-slate-800", tabs: "17-19" },
